<nav class="navbar navbar-expand-md navbar-light bg-warning shadow-sm fs-5">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('contents') }}">{{ __('Курс') }}</a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav ms-auto">
                ...
                @else
                    @if(Auth::user()->admin == 1)
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('admin') }}">{{ __('Админка') }}</a>
                        </li>
                    @endif
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="dropdown-item" href="{{ route('home') }}">{{ __('Личный кабинет') }}</a>
